  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
        ...
        <h1 className="text-gray-900 text-2xl mt-2 title-font font-medium mb-4">Order Id : #1</h1>
        ...
        <p className="leading-relaxed mb-4">Your order is Placed  successfully !</p>
        ...
        <div className="flex">
          ...
          <button className="flex ml-auto text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded">Trake Order</button>

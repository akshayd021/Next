    ...
    <div className="flex flex-col md:flex-row md:justify-start justify-center items-center py-2 shadow-md sticky top-0 z-10 bg-white">
      ...
      <div className="absolute right-2  justify-center gap-3 flex text-center cursor-pointer">
        ...
        <div
          ...
          className="origin-top-right absolute right-5 w-40 mt-8 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none"
        >
          {show && (
            <div
              className="py-1"
        ...
        {!user?.value && (
          <Link href={"/login"}>
        <button className="text-white text-sm bg-pink-500 border-0  px-3 focus:outline-none hover:bg-pink-600 rounded" > Login</button>
          </Link>
        )}
                    ...
                    <div className="flex justify-between gap-3 mt-4">
                      <Link href={"/checkout"}>
                        <button
                          ...
                          className="text-white text-sm disabled:bg-pink-300 bg-pink-500 border-0 py-2 px-3 focus:outline-none hover:bg-pink-600 rounded"
                        >
                          Checkout
                        </button>
                      </Link>
